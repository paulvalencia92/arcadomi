    ...
    <iq-card>
      <b-row class="d-flex align-items-center mb-2">
        ...
        <b-col md="3" class="text-right">
          <b-button variant="none" class="text-primary" @click="addToBookmark(currentRoute)" v-if="!selectedBookmark"><i
              class="ri-star-line font-size-24"></i></b-button>
          <b-button variant="none" class="text-warning" @click="removeToBookmark(currentRoute)" v-else><i
              class="ri-star-fill font-size-24"></i></b-button>
        </b-col>
      </b-row>
    </iq-card>
  </b-col>
