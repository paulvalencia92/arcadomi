          ...
          <template v-slot:body>
            <div class="profile-header">
              <div class="cover-container">
                <b-img v-bind:src="userDefault.background" alt="profile-bg" rounded fluid class="w-100"/>
                    ...
                    <div class="user-detail pl-5">
                      <div class="d-flex flex-wrap align-items-center">
                        <div class="profile-img pr-4">
                          <b-img v-bind:src="user.image ? user.image : userDefault.profile" alt="profile-img" fluid class="avatar-130"/>
                        </div>
              ...
              <template v-slot:body>
                <ul class="m-0 p-0">
                  <li class="d-flex" v-for="(list,index) in news" :key="index" :class="{ 'mb-2': index === 0 }">
                    <div class="news-icon" :class="{ 'mb-0': index==news.length-1 }"><i class="ri-chat-4-fill"></i>
                    </div>
                ...
                <iq-card body-class="p-0">
                        ...
                        <div class="iq-card-header-toolbar d-flex align-items-center">
                          <b-dropdown id="dropdownMenuButton40" right variant="none" menu-class="p-0">
                            <template v-slot:button-content>
                              <b-link href="#" class="text-secondary">29 mins <i class="ri-more-2-line ml-3"></i>
                              </b-link>
                            </template>
                            <b-dropdown-item href="#"><i class="ri-user-unfollow-line mr-2"></i>Unfollow
                            </b-dropdown-item>
                  ...
                  <div class="user-post">
                    <b-link href="javascript:void(0);">
                      <b-img :src="require('../../assets/images/page-img/p1.jpg')" alt="post-image" fluid/>
                    </b-link>
                  </div>
                  <div class="comment-area p-3">
                      ...
                      <div class="d-flex align-items-center">
                        <div class="iq-media-group">
                          <b-link href="#" class="iq-media">
                            <b-img class="avatar-40" rounded="circle" fluid
                                   :src="require('../../assets/images/user/user-05.jpg')" alt=""/>
                          </b-link>
                          <b-link href="#" class="iq-media">
                            <b-img class="avatar-40" rounded="circle" fluid
                                   :src="require('../../assets/images/user/user-06.jpg')" alt=""/>
                          </b-link>
                          <b-link href="#" class="iq-media">
                            <b-img class="avatar-40" rounded="circle" fluid
                                   :src="require('../../assets/images/user/user-07.jpg')" alt=""/>
                          </b-link>
                          <b-link href="#" class="iq-media">
                            <b-img class="avatar-40" rounded="circle" fluid
                                   :src="require('../../assets/images/user/user-08.jpg')" alt=""/>
                          </b-link>
                          <b-link href="#" class="iq-media">
                            <b-img class="avatar-40" rounded="circle" fluid
                                   :src="require('../../assets/images/user/user-09.jpg')" alt=""/>
                          </b-link>
                        </div>
                    ...
                    <ul class="post-comments p-0 m-0">
                      <li class="mb-2">
                        <div class="d-flex flex-wrap">
                          <div class="user-img">
                            <b-img :src="require('../../assets/images/user/user-02.jpg')" alt="userimg"
                      ...
                      <li>
                        <div class="d-flex flex-wrap">
                          <div class="user-img">
                            <b-img :src="require('../../assets/images/user/user-03.jpg')" alt="userimg"
                                   class="avatar-35" rounded="circle" fluid/>
                          </div>
                          <div class="comment-data-block ml-3">
                            <h6>Paul Molive</h6>
                ...
                <iq-card body-class="p-0">
                  <template v-slot:body>
                    ...
                    <p class="p-3 mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi nulla dolor,
                      ornare at commodo non, feugiat non nisi. Phasellus faucibus mollis pharetra. Proin blandit ac
                      massa sed rhoncus</p>
                    <div class="comment-area p-3">
                      <hr class="mt-0">
                      <div class="d-flex justify-content-between align-items-center">
          ...
          <b-col lg="3" class="profile-right">
            <iq-card>
              ...
              <template v-slot:body>
                <div class="about-info m-0 p-0">
                  <b-row>
                    <b-col cols="3">Correo electronico:</b-col>
                    <b-col cols="9">
                      <b-link v-bind:href="user.email"> {{ user.email }}</b-link>
                    </b-col>
                    <b-col cols="3">Telefono:</b-col>
                    <b-col cols="9">
                      <b-link v-bind:href="user.movil_number">{{  user.movil_number }}</b-link>
                    </b-col>
                    <b-col cols="3">Locación:</b-col>
                    <b-col cols="9">Colombia</b-col>
                  </b-row>
                </div>
              </template>
            </iq-card>
            ...
            <iq-card>
              ...
              <template v-slot:body>
                ...
                <b-link href="javascript:void(0);" class="btn btn-primary d-block"><i class="ri-add-line"></i> Load More
                </b-link>
              </template>
            </iq-card>
          </b-col>
